...
def fitness_function(x):
    ...
    for i, vm_config in enumerate(x):
        ...
        fitness_value = ((0.4*execution_time)/cpus + ram) + (0.6*100*(cpus + vm_config[1]))
...
print("Optimal VM configuration: vCPUs =", optimal_cpus, ", Memory =", optimal_ram*1000, "MB")
